...
class TestMetaEnvPretrainedWithoutSoC(unittest.TestCase):
    ...
    def test_different_situations(self, input_noise_mock, ppo_moonlander_predict_mock) -> None:
        ...
        # define env
        env = gym.make("MetaEnv-pretrained-without-SoC",
        ...
        with self.subTest("three steps action 0"):
            ...
            np.testing.assert_array_equal(new_state_active, env.state_of_collect_task_one)
            ...
            np.testing.assert_array_equal(new_state_inactive, env.state_of_collect_task_two)
        ...
        with self.subTest("switch to action 1"):
            ...
            np.testing.assert_array_equal(new_state_active, env.state_of_collect_task_two)
            ...
            np.testing.assert_array_equal(new_state_inactive, env.state_of_collect_task_one)
